...
public class Delimiter {
    ...
    public static void main(String[] args){
        ...
        System.out.println("Enter two very big integers(one the same line)");
        long bigNum1 = scan.nextLong();
        long bigNum2 = scan.nextLong();
        System.out.println("Enter two decimals(one the same line)");
        double decimal1 = scan.nextDouble();
        double decimal2 = scan.nextDouble();
        System.out.println("Enter two values(one the same line)");
